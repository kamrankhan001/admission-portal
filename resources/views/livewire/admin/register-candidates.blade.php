<main>
    <div class="container-fluid px-4">
        <h1 class="mt-4">Register Users</h1>
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Candidates / Register Candidates</li>
        </ol>
        ...
        <div class="card mb-3">
            ...
            <div class="row my-2 px-3">
                <div class="col-md-6 col-12 mb-3">
                    <a href="{{route('register_user_export')}}" class="btn btn-dark">Excel</a>
                </div>
